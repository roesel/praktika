...
#x,y,z # z s errorama
d1 = np.loadtxt(script_name()+".txt", converters = {0: cf, 1: cf})
x1,y1 = d1[:,0],d1[:,1]
#
#dfit = d[d[:, 0] < 250]
...
plt.clf()
plt.semilogy(x1/60,y1,'x', color="blue", label=u"Naměřené hodnoty", ms=10)
...
# Uložení
plt.savefig(script_name()+'.pdf', format='pdf', dpi=1200)
plt.show()
