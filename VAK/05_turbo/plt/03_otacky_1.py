...
d = g.loadtxt(name="03_otacky_1.txt")
...
g.clf()
g.plot(x/60+0.35,y,'o', color="blue", label=u"Naměřené hodnoty", ms=7)
if (fitting): g.plot(x,y_fit, label=fitlabel)

g.ylim(800,1550)
g.xlim(0,5)

g.cosmetics(labels=["$t$ [min]", "$f$ [Hz]"], loc=4)

g.save(name="03_otacky_1")
g.show()
