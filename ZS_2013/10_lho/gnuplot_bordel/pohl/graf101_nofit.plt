...
h=8
d=31
#fit f(x) name using 1:2 via a,l,o,h,d
titulek1="data"
titulek2="fit" #fit: f(x)=(-370±30)·exp(-(0,53±0,01)x)·cos((16,19±0,01)x-(6,70±0,07))-(15,11±0,06)"     
#set label "f(x) = (%.2f", a, "\261%.2f) ", a_err, "exp(-(%.2f", l, "\261%.2f)x) ", l_err, "cos((%.2f", o, "\261%.2f)x ", o_err, "+ (%.2f", h, "\261%.2f)) ", h_err, "+ (%.2f", d, "\261%.2f)) ", d_err   at graph 0.02, graph 0.05
set xlabel "t [s]"
set ylabel "x [mm]"
