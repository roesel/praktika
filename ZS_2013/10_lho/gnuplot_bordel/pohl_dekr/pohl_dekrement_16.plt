...
#titulek2 = sprintf("f(t) = (%.2f\261%.2f) e^{-(%.3f\261%.3f)t} cos( (%.3f\261%.3f)t + (%.2f\261%.2f) ) )", a, a_err, l, l_err, o, o_err, h, h_err )
...
plot name.".txt" with points title titulek1 lw 2 lt 1 lc rgb "red"      #, f(x) lw 2 lt 3 title titulek2
